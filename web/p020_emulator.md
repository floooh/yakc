...
- single-step-debugger, disassembler and memory editor windows
...
The emulator can optionally be compiled without the debugger UI through
a cmake-option, reducing it's download size by half.
