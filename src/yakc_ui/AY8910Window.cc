...
AY8910Window::Draw(yakc& emu) {
    ...
    if (ImGui::Begin(this->title.AsCStr(), &this->Visible, ImGuiWindowFlags_ShowBorders)) {
        ...
        ImGui::Text("Noise Period: 0x%02X", snd.regs[ay8910::NOISE_PERIOD]);
        ImGui::Text("Enable:       0x%02X", snd.regs[ay8910::ENABLE]);
        ImGui::Text("Amp A:        0x%02X", snd.regs[ay8910::AMP_A]);
        ImGui::Text("Amp B:        0x%02X", snd.regs[ay8910::AMP_B]);
        ImGui::Text("Amp C:        0x%02X", snd.regs[ay8910::AMP_C]);
        ImGui::Text("Period Env:   0x%04X", (snd.regs[ay8910::ENV_PERIOD_COARSE]<<8)|snd.regs[ay8910::ENV_PERIOD_FINE]);
