...
KC85IOWindow::Draw(yakc& emu) {
    ...
    if (ImGui::Begin(this->title.AsCStr(), &this->Visible)) {
        if (ImGui::CollapsingHeader("PIO A (0x88)")) {
            ...
            onOffLine("Bit 2: IRM", 0 != (a&KC85_PIO_A_IRM));
            onOffLine("Bit 3: RAM R/O", 0 != (a&KC85_PIO_A_RAM_RO));
            onOffLine("Bit 4: unused", 0 != (a&KC85_PIO_A_UNUSED));
            onOffLine("Bit 5: tape LED", 0 != (a&KC85_PIO_A_TAPE_LED));
        ...
        if (ImGui::CollapsingHeader("PIO B (0x89)")) {
            ...
            if (emu.is_system(system::kc85_4)) {
                onOffLine("Bit 5: RAM8", 0 != (b&KC85_PIO_B_RAM8));
                onOffLine("Bit 6: RAM8 R/O", 0 != (b&KC85_PIO_B_RAM8_RO));
            }
            else {
        ...
        if (emu.is_system(system::kc85_4)) {
            if (ImGui::CollapsingHeader("Port 0x84")) {
                ...
                onOffLine("Bit 2: access image 0/1", 0 != (v&KC85_IO84_SEL_CPU_IMG));
                onOffLine("Bit 3: lo/hi-color mode", 0 != (v&KC85_IO84_HICOLOR));
                onOffLine("Bit 4: RAM8 select 0/1", 0 != (v&KC85_IO84_SEL_RAM8));
                onOffLine("Bit 5: RAM8 block (?)", 0 != (v&KC85_IO84_BLOCKSEL_RAM8));
