...
// default cycle count tables, taken from MAME
static const uint32_t def_cc_op[0x100] = {
...
static const uint32_t def_cc_cb[0x100] = {
...
static const uint32_t def_cc_ed[0x100] = {
...
static const uint32_t def_cc_xy[0x100] = {
...
static const uint32_t def_cc_xycb[0x100] = {
...
static const uint32_t def_cc_ex[0x100] = {
...
z80::init_tables() {
    ...
    this->cc_op = def_cc_op;
    this->cc_cb = def_cc_cb;
    this->cc_ed = def_cc_ed;
    this->cc_xy = def_cc_xy;
    this->cc_xycb = def_cc_xycb;
    this->cc_ex = def_cc_ex;
}
