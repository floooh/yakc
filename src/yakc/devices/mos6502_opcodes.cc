...
uint32_t mos6502::do_op(system_bus* bus) {
  ...
  switch(fetch_op()) {
    ...
    case 0x11: ora(addr_iyl()); break;
    case 0x15: ora(addr_zi(X)); break;
    case 0x16: asl(addr_zi(X)); break;
    case 0x19: ora(addr_ail(Y)); break;
    case 0x1d: ora(addr_ail(X)); break;
    case 0x1e: asl(addr_ais(X)); break;
    case 0x20: jsr(); break;
    ...
    case 0x31: anda(addr_iyl()); break;
    case 0x35: anda(addr_zi(X)); break;
    case 0x36: rol(addr_zi(X)); break;
    case 0x39: anda(addr_ail(Y)); break;
    case 0x3d: anda(addr_ail(X)); break;
    case 0x3e: rol(addr_ais(X)); break;
    case 0x40: rti(); break;
    ...
    case 0x51: eor(addr_iyl()); break;
    case 0x55: eor(addr_zi(X)); break;
    case 0x56: lsr(addr_zi(X)); break;
    case 0x59: eor(addr_ail(Y)); break;
    case 0x5d: eor(addr_ail(X)); break;
    case 0x5e: lsr(addr_ais(X)); break;
    case 0x60: rts(); break;
    ...
    case 0x71: adc(addr_iyl()); break;
    case 0x75: adc(addr_zi(X)); break;
    case 0x76: ror(addr_zi(X)); break;
    case 0x79: adc(addr_ail(Y)); break;
    case 0x7d: adc(addr_ail(X)); break;
    case 0x7e: ror(addr_ais(X)); break;
    ...
    case 0xb1: lda(addr_iyl()); break;
    case 0xb4: ldy(addr_zi(X)); break;
    case 0xb5: lda(addr_zi(X)); break;
    case 0xb6: ldx(addr_zi(Y)); break;
    case 0xb9: lda(addr_ail(Y)); break;
    case 0xba: tsx(); break;
    case 0xbc: ldy(addr_ail(X)); break;
    case 0xbd: lda(addr_ail(X)); break;
    case 0xbe: ldx(addr_ail(Y)); break;
    ...
    case 0xd1: cmp(addr_iyl()); break;
    case 0xd5: cmp(addr_zi(X)); break;
    case 0xd6: dec(addr_zi(X)); break;
    case 0xd9: cmp(addr_ail(Y)); break;
    case 0xdd: cmp(addr_ail(X)); break;
    case 0xde: dec(addr_ais(X)); break;
    ...
    case 0xf1: sbc(addr_iyl()); break;
    case 0xf5: sbc(addr_zi(X)); break;
    case 0xf6: inc(addr_zi(X)); break;
    case 0xf9: sbc(addr_ail(Y)); break;
    case 0xfd: sbc(addr_ail(X)); break;
    case 0xfe: inc(addr_ais(X)); break;
